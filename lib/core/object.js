...
exports.rename = exports.walkAll = exports.walk = exports.deepEach = exports.removeItem = exports.against = exports.shallowEqual = exports.different = exports.mergeDefault = exports.setDefault = exports.exist = exports.truthy = exports.isNull = exports.pick = exports.omit = exports.invert = exports.unzip = exports.zip = exports.unpairs = exports.pairs = exports.values = exports.map2Array = exports.map = exports.mapKey = exports.filter = exports.reduce = exports.each = exports.plucker = exports.typeGetter = exports.typeChecker = exports.identity = exports.keys = undefined;
...
var truthy = function truthy(obj) {
  return !!obj && ((typeof obj === 'undefined' ? 'undefined' : (0, _typeof3.default)(obj)) === 'object' ? !!(0, _keys2.default)(obj).length : true);
};
...
// 递归所有的键
var walkAll = function walkAll(obj, handler) {
  ...
  (0, _keys2.default)(obj).forEach(function (key, index) {
    return (0, _typeof3.default)(obj[key]) === 'object' && walkAll(obj[key], handler, parentPath.concat(key), index);
  });
};

// 重命名
var rename = function rename(value, rn) {
  if (rn === undefined || (typeof value === 'undefined' ? 'undefined' : (0, _typeof3.default)(value)) !== 'object') {
    return value;
  } else if (Array.isArray(value)) {
    return (0, _array.asname)(value, rn);
  }
