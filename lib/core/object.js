...
var filter = function filter(obj, handler) {
  return reduce(obj, function (last, value, key) {
    return handler(value, key) ? (0, _extends8.default)({}, last, (0, _defineProperty3.default)({}, key, value)) : last;
  });
};

var mapKey = function mapKey(obj, keymap) {
  return reduce(obj, function (last, value, key) {
    return (0, _extends8.default)({}, last, (0, _defineProperty3.default)({}, keymap[key], value));
  });
};
...
var map = function map(obj, handler) {
  return reduce(obj, function (last, value, key) {
    return (0, _extends8.default)({}, last, (0, _defineProperty3.default)({}, key, handler(value, key)));
  });
};
...
var invert = function invert(obj) {
  return reduce(obj, function (last, value, key) {
    return (0, _extends8.default)({}, last, (0, _defineProperty3.default)({}, value, key));
  });
};
...
var zip = function zip(zipKeys, zipValues) {
  return zipKeys.reduce(function (last, key, index) {
    return (0, _extends8.default)({}, last, (0, _defineProperty3.default)({}, key, zipValues[index]));
  }, {});
};
...
var mergeDefault = function mergeDefault(object, defaultValue) {
  return (0, _extends8.default)({}, defaultValue, object);
};
