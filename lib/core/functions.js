...
var compose = function compose(first) {
  for (var _len10 = arguments.length, last = Array(_len10 > 1 ? _len10 - 1 : 0), _key10 = 1; _key10 < _len10; _key10++) {
    last[_key10 - 1] = arguments[_key10];
  }
...
var concat = function concat() {
  for (var _len11 = arguments.length, funs = Array(_len11), _key11 = 0; _key11 < _len11; _key11++) {
    funs[_key11] = arguments[_key11];
  }
...
var choose = function choose() {
  for (var _len16 = arguments.length, conditions = Array(_len16), _key16 = 0; _key16 < _len16; _key16++) {
    conditions[_key16] = arguments[_key16];
  }
