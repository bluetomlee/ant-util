...
exports.complement = exports.not = exports.inject = exports.partialLeft = exports.partial = exports.guard = exports.grund = exports.choose = exports.curryless = exports.curry2 = exports.curry1 = exports.curry = exports.some = exports.concat = exports.compose = exports.anyness = exports.allness = exports.any = exports.all = exports.matchOne = exports.match = exports.invoker = exports.invoke = exports.run = exports.exer = exports.exec = exports.binds = exports.always = exports.translate = undefined;
...
var matchOne = function matchOne(actions) {
  return function () {
    return (0, _array.finder)(match(actions).apply(undefined, arguments), _object.identity);
  };
};
...
var grund = function grund() {
  console.warn('`grund` is deprecated, please use `guard`.');
  return guard.apply(undefined, arguments);
};
...
var complement = function complement() {
  ...
  return not.apply(undefined, arguments);
};
